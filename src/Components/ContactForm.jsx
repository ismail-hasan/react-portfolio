                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-12">
                    ...
                    <div className="md:w-1/2 w-full space-y-8">
                        ...
                        <div className="space-y-6">
                            {/* Location Section with Glass Prism Effect and Icon */}
                            <div className="p-6 bg-white/20 backdrop-blur-md border-2 border-white/30 rounded-lg shadow-lg flex items-center gap-4">
                                <svg
                                ...
                                >
                                    <path d="M12 2C8.13 2 5 5.13 5 8C5 10.41 7.24 13.72 9.78 16.26L12 19L14.22 16.26C16.76 13.72 19 10.41 19 8C19 5.13 15.87 2 12 2ZM12 11C10.34 11 9 9.66 9 8C9 6.34 10.34 5 12 5C13.66 5 15 6.34 15 8C15 9.66 13.66 11 12 11Z" />
                                </svg>
                                <div>
                                    <h3 className="font-semibold text-lg">Location</h3>
                                    <p className="text-gray-300">Guwahati, Assam, 781023</p>
                                </div>
                            </div>

                            {/* Email Section with Glass Prism Effect and Icon */}
                            <div className="p-6 bg-white/20 backdrop-blur-md border-2 border-white/30 rounded-lg shadow-lg flex items-center gap-4">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    ...
                                    className="text-white"
                                >
                                    <path d="M22 12V2H2v20h20V12ZM20 4v4l-8 4-8-4V4h16ZM4 6v3.23l7.03 3.52L12 14l.97-.25L20 9.23V6H4z" />
                                </svg>
                                <div>
                                    <h3 className="font-semibold text-lg">Email</h3>
                                    <p className="text-gray-300">narizasfakur@gmail.com</p>
                                </div>
                            </div>

                            {/* Phone Section with Glass Prism Effect and Icon */}
                            <div className="p-6 bg-white/20 backdrop-blur-md border-2 border-white/30 rounded-lg shadow-lg flex items-center gap-4">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-300">+91 8638899505</p>
                                    <p className="text-gray-300">+91 7896875185 (WhatsApp)</p>
                                </div>
                            </div>
                        </div>
                    </div>
