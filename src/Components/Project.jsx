    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-gray-900">
            ...
            <div className="absolute inset-0 w-full h-full">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-900 to-slate-900 opacity-60"></div>
                <div className="absolute inset-0 bg-[url('/api/placeholder/1200/800')] bg-cover bg-center mix-blend-overlay"></div>

            </div>

            {/* Content container */}
            <div className="relative  items-center justify-center m-20">
                ...
                <div className='grid grid-cols-2 gap-20'>
                    <div
                        className={`relative  max-w-lg  p-8 rounded-xl transition-all duration-500 ${isHovered ? 'scale-105 shadow-2xl' : 'scale-100 shadow-xl'
                            }`}
                        style={{
                    ...
                    >
                        ...
                        <div>
                            <div className=" z-10">
                                ...
                                <p className="text-white text-lg mb-6 w">
                    ...
                    <div
                        className={`relative w-full max-w-lg -ml-50 p-8 rounded-xl transition-all duration-500 ${isHovered ? 'scale-105 shadow-2xl' : 'scale-100 shadow-xl'
                            }`}
                        style={{
                            background: 'rgba(255, 255, 255, 0.1)',
                            backdropFilter: 'blur(10px)',
